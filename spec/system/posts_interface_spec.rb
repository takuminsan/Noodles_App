...
describe '投稿', type: :system do
  ...
  it '投稿一連のテスト' do
    ...
    expect(page).to have_field 'post_shop_name', with: 'ラーメンNoodle'
    expect(page).to have_field 'post_nearest', with: '新宿駅'
    expect(page).to have_field 'post_content', with: '美味しいね'
